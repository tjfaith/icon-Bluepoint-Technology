...
> <strong>[Upgrade to Pro!](https://web-lodge.com/product/post-carousel-slider-for-elementor/)</strong> 
...
There is also a [Pro Version](https://web-lodge.com/product/post-carousel-slider-for-elementor/) of this plugin. You will get more features and advantages on the [Pro Version](https://web-lodge.com/product/post-carousel-slider-for-elementor/). **[Post Carousel Slider for Elementor Pro](https://web-lodge.com/product/post-carousel-slider-for-elementor/)** is a multi-purpose responsive **Post Showcase plugin** that allows you to show more **Posts (any post type)** in a beautiful **Carousel Slider**. It has plenty of extremely user-friendly options and supports **Post, Custom Post, Taxonomy, Custom Taxonomy, Specific Posts, and more**. You can fully **Customize the Style** with the [PRO Version](https://web-lodge.com/product/post-carousel-slider-for-elementor/). 
